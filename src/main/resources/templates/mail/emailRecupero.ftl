    ...
    <table width="80%" cellspacing="0" cellpadding="0" border="0"  align="center" height="200" style="margin: 25px auto;">
            ...
            <td width="600" bgColor="#EEF0F1" style="padding: 25px;" aligne="none">
                ...
                <div style="padding: 25px;">
                    <p><span>Se ha solicitado el recupero de contraseña. Sus nuevas credenciales para ingresar al sistema son: </span></p>
                </div>
                <div style="padding: 25px;">
					<span>Usuario: <span style="font-weight: bold;">${nombreUsuario}</span></span>
					<br><br>		
					<span>Contraseña: <span style="font-weight: bold;">${passwordUsuario}</span></span>
                </div>
                <div style="padding: 25px;">
					<br><small> 
					<span>
