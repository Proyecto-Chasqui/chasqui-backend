...
<body  style=" font-family: arial, sans-serif;">
    ...
    <table width="80%" cellspacing="0" cellpadding="0" border="0"  align="center" height="200" style="margin: 25px auto;">
            ...
            <td width="600" bgColor="#EEF0F1" style="padding: 25px;" aligne="none">
                <p><span>Estimado usuario: <span style="font-weight: bold;">${nombreApellido}</span>,</span></p> <!-- header del cuerpo -->
                <div style="padding: 25px;"> <!-- principio del cuerpo -->
              
                    <div style="padding: 25px;">
                      <span>Le damos la bienvenida a la plataforma Chasqui.</span>
                      </span>
                      <br><br>
                      		<span>Su usuario es: <span style="font-weight: bold;">${email}</span>
                      </span>
                      </span>
                </div><!-- fin del cuerpo -->
