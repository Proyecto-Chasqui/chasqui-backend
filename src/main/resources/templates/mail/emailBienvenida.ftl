...
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 10pt; color: #777777; height: 90px;"><img src="cid:logochasqui" border="0" alt="Chasqui" /></td>
</tr>
<!-- Imagen de referencia -->
<tr style="height: 130px;">
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 10pt; color: #777777; text-align: center; height: 130px;"><img src="cid:bienvenido" width="100%" border="0" alt="Comunidad de consumo solidario" /></td>
</tr>
...
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #777777; text-align: center; height: 21px;">Hola, te damos la bienvenida al Panel de administración de Chasqui. Tus credenciales para ingresar al sistema son:</td>
</tr>
...
<tr style="height: 21px;">
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #777777; text-align: center; height: 21px;">Usuario: <span style="font-weight: bold; color: #00adee;">${nombreUsuario}</span></td>
</tr>


<tr style="height: 21px;">
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #777777; text-align: center; height: 21px;">Contraseña: <span style="font-weight: bold; color: #00adee;">${passwordUsuario}</span></td>
</tr>
...
<tr style="height: 21px;">
	<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #777777; text-align: center; height: 21px;">
		Te sugerimos, por motivos de seguridad, que una vez que ingreses al panel de administración, cambies esta contraseña en la sección configuración.
	</td>
</tr>
...
<tr style="height: 20px;">
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #777777; text-align: center; height: 20px;">&iquest;Queres saber más de Chasqui? Ingresá a:</td>
</tr>
<tr style="height: 40px;">
