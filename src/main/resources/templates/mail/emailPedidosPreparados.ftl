            ...
            <td width="600" bgColor="#EEF0F1" style="padding: 25px;" aligne="none">
                ...
                <div style="padding: 25px;"> <!-- principio del cuerpo -->
                         <div style="padding: 25px;">
                             <span>
                              <p>Los pedidos dentro de su grupo de compras colectivas estan siendo preparados para ser enviados. El detalle de los pedidos es el siguiente:</p>
                          </span>
                          ${tablaContenidoDePedidoColectivo}	
                         </div>
