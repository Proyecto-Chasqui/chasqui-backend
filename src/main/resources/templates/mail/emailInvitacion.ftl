...
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 10pt; color: #777777; text-align: center; height: 130px;"><a href="http://www.proyectochasqui.com"><img src="cid:invitacion" width="100%" border="0" alt="Comunidad de consumo solidario" /></a></td>
</tr>
...
<tr style="height: 21px;">
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #777777; text-align: center; height: 21px;">Chasqui es una aplicación que te permite conocer y comprar los productos de la economía social, que tienen precio justo, trabajo legítimo y de fabricación sustentable.
Descargate la app para navegar el catálogo de <span style="font-weight: bold; color: #00adee;">${vendedor}</span></td>
</tr>
...
<tr style="height: 21px;">
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #777777; text-align: center; height: 21px;">Le comentamos que el usuario:<span style="font-weight: bold; color: #00adee;">${usuarioOrigen}</span> <span style="font-weight: bold; color: #00adee;">(${mailOrigen})</span>  desea invitarlo a que pruebes Chasqui.</td>
</tr>
