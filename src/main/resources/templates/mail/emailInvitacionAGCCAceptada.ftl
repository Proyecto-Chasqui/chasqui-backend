...
<body  style=" font-family: arial, sans-serif;">
    ...
    <table width="80%" cellspacing="0" cellpadding="0" border="0"  align="center" height="200" style="margin: 25px auto;">
            ...
            <td width="600" bgColor="#EEF0F1" style="padding: 25px;" aligne="none">
                <p><span>Estimado usuario: <span style="font-weight: bold;">${nombreUsuario}</span>,</span></p> <!-- header del cuerpo -->
                <div style="padding: 25px;"> <!-- principio del cuerpo -->
              
                    <div style="padding: 25px;">
                      <span>La invitacion al grupo de compras colectivas <span style="font-weight: bold;">${aliasGrupo}</span> del usuario <span style="font-weight: bold;">${usuarioInvitado}</span> para el vendedor <span style="font-weight: bold;">${vendedor}</span> ha sido aceptada. </span>
                      </span>
                      <br>
                </div><!-- fin del cuerpo -->
