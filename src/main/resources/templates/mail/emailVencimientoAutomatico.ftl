...
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 10pt; color: #777777; text-align: center; height: 130px;"><a href=${catalogoVendedor}><img src="cid:vencimiento" width="100%" border="0" alt="Comunidad de consumo solidario" /></a></td>
</tr>
