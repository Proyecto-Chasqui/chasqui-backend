...
<body id="cuerpo">
    <table width="600" align="center" cellpadding="0" cellspacing="0" border="0">
        <tbody>
            ...
            <tr style="height: 21px;">
                <td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #777777; text-align: center; height: 21px;"> <span style="font-weight: bold; color: #00adee;">${nombreInvitado}</span> <span style="font-weight: bold; color: #00adee;">${apellidoInvitado}</span> (<span style="font-weight: bold; color: #00adee;">${usuarioInvitado}</span>) aceptó tu
                    invitación al nodo de compras colectivas <span style="font-weight: bold; color: #00adee;">${aliasGrupo}</span>.</td>
            </tr>

            <tr style="height: 21px;">
                <td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #777777; text-align: center; height: 21px;">Podrás ver sus compras en el nodo ingresando a la sección Mis Nodos. Recordá que administrás el nodo y por eso tenés que confirmar el pedido colectivo una vez se hayan realizado todas las compras.
                </td>
            </tr>
