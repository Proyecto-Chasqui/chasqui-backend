...
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 10pt; color: #777777; text-align: center; height: 130px;"><a href="http://www.proyectochasqui.com"><img src="cid:confirmacion" width="100%" border="0" alt="Comunidad de consumo solidario" /></a></td>
</tr>
...
<tr style="height: 21px;">
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #777777; text-align: center; font-weight: bold; height: 21px;">Los datos de la dirección de entrega son los siguientes: ${tablaDireccionDeEntrega}</td>
</tr>
<tr style="height: 40px;">
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 10pt; color: #777777; text-align: justify; height: 40px;">&nbsp;</td>
</tr>
...
<tr style="height: 21px;">
<td style="margin: 0px; padding: 0px; border: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #777777; text-align: center; height: 21px;">${agradecimiento}</td>
</tr>
